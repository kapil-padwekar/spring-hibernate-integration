package com.osl.mvcapp.util.rest;
        ...
        try {
             ...
             while( rs.next() ) {
                 ...
                 for (int i=1; i<numColumns+1; i++) {
                  ...
                  //comment to be removed  	 //temp = ESAPI.encoder().canonicalize(temp); //decoding data to base state
                  //comment to be removed  	 //temp = ESAPI.encoder().encodeForHTML(temp); //encoding to be browser safe
